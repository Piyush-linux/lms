<template>
    <div class="">
            ...
            <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <div class="mt-8 flex flex-wrap justify-center gap-4">
                        <a class="block w-full rounded border border-emerald-500 bg-emerald-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto" href="/get-started">
                            Get Started
                        </a>
                        <a class="block w-full rounded border border-emerald-600 px-12 py-3 text-sm font-medium text-emerald hover:bg-emerald-600 focus:outline-none focus:ring active:bg-emerald-500 text-emerald-700 hover:text-white sm:w-auto" href="/about">
                            Learn More
                        </a>
                    </div>
                </div>
        ...
        <div class="relative p-10 bg-gray-100 ">
            <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center h-screen">
                    ...
                    <ul class="mt-10">
                        <li>
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center w-12 h-12 text-white bg-emerald-500 rounded-md">
                                        <span class="iconify w-6 h-6" data-icon="mdi:book"></span>
                                    </div>
                                </div>
                                <div class="ml-4">
                        ...
                        <li class="mt-10">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center w-12 h-12 text-white bg-emerald-500 rounded-md">
                                        <span class="iconify w-7 h-7" data-icon="basil:clock-solid"></span>
                                    </div>
                                </div>
                                <div class="ml-4">
                                    <h5 class="text-lg font-bold leading-6 text-gray-900 ">
                                    ...
                                    <p class="mt-2 text-base leading-6 text-gray-500 ">
                                        Enroll in courses according <br> to your schedule
                                    </p>
                                </div>
                            </div>
                        </li>
                        <li class="mt-10">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center w-12 h-12 text-white bg-emerald-500 rounded-md">
                                        <span class="iconify w-7 h-7" data-icon="basil:google-drive-solid"></span>
                                    </div>
                                </div>
                                <div class="ml-4">
                                    <h5 class="text-lg font-bold leading-6 text-gray-900 ">
                ...
                <div class="relative mt-10 -mx-4 md:-mx-12 lg:mt-0 lg:col-start-1">
                    <img src="mcc.png" alt="illustration" class="relative w-1/2 mx-auto rounded shadow-lg" />
                </div>
            </div>
        </div>
        <!-- 3 -->
        <section class="m-5 md:m-8  text-gray-800 h-auto">
            <div class="container mx-auto p-4 my-6 space-y-2 text-center">
                <h2 class="text-5xl font-bold">TECHSTACK</h2>
            ...
            <div class="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div class="flex flex-col items-center p-4">
                    <span class="iconify w-10 h-10 text-emerald-600" data-icon="tabler:brand-nuxt"></span>
                    <h3 class="my-3 text-3xl font-semibold">NUXT</h3>
                    <div class="space-y-1 leading-tight text-gray-600 text-center">
                        <p>Online / Offline</p>
                ...
                <div class="flex flex-col items-center p-4">
                    <span class="iconify w-10 h-10 text-emerald-600" data-icon="simple-icons:prisma"></span>
                    <h3 class="my-3 text-3xl font-semibold">PRISMA</h3>
                    <div class="space-y-1 leading-tight text-gray-600 text-center">
                        <p>Know Learning Path</p>
                        <p>Know Instructor</p>
                        <p>Know Schedule</p>
                    </div>
                </div>
                <div class="flex flex-col items-center p-4">
                    <span class="iconify w-10 h-10 text-emerald-600" data-icon="mdi:tailwind"></span>
                    <h3 class="my-3 text-3xl font-semibold">TAILWIND</h3>
                    <div class="space-y-1 leading-tight text-gray-600 text-center">
                        <p>Online / Offline</p>
                        <p>Tempore quasi porro</p>
                        <p>Blanditiis aut mollitia ex</p>
