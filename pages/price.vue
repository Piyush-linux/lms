    ...
    <div class="">
        <section class="max-w-7xl px-4 pt-24 pb-12 mx-auto">
            <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                ...
                <p class="px-0 mb-10 text-lg text-gray-500 md:text-xl lg:px-24">
                  ...
                  <!-- Developer -->
                    <div class="border-0 rounded-none shadow-none card sm:rounded-lg md:border">
                        <div class="flex flex-col justify-between p-6 border-b border-gray-200">
                            <p class="mb-1 text-lg font-semibold text-emerald-700">Developer</p>
                            <p class="pb-0 my-2 font-mono text-4xl font-extrabold text-gray-900">$0</p>
                            <p class="text-sm text-gray-500">Life Time</p>
                            <a href="#" class="w-full mt-6 btn btn-warning text-emerald-700 btn-lg">
                        ...
                        <ul class="flex flex-col flex-grow p-6 space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700"> Self Hosted </span>
                            </li>
                            <li class="flex items-start">
                                <svg viewBox="0 0 20 20" fill="currentColor" class="flex-none w-4 h-4 mt-1 mr-2 text-yellow-600">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                                <span class="text-gray-700">Customize Accordingly</span>
                            </li>
                            <li class="flex items-start">
                                <svg viewBox="0 0 20 20" fill="currentColor" class="flex-none w-4 h-4 mt-1 mr-2 text-yellow-600">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            ...
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Upcoming New Features</span>
                            </li>
                        </ul>
                    </div>
                    <!-- Organization -->
                        ...
                        <div class="flex flex-col justify-between p-6 border-b border-gray-200">
                            <div>
                                <div class="flex items-center justify-between">
                                    <p class="mb-1 text-lg font-semibold text-purple-700">Organization</p>
                    ...
                    <div class="border-0 rounded-none shadow-none card sm:rounded-lg md:border">
                        <div class="flex flex-col justify-between p-6 border-b border-gray-200">
                            ...
                            <a href="#" class="w-full mt-6 text-pink-600 btn btn-light btn-lg">Initiate a chat</a>
                        </div>
                        <ul class="flex flex-col flex-grow p-6 space-y-3">
                            <li class="flex items-start">
