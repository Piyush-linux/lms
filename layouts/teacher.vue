            ...
            <div class="flex">
                <aside class="h-screen flex flex-col w-64 h-auto px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <div class="flex flex-col justify-between flex-1 mt-6">
                        <nav>
                            <NuxtLink class="flex items-center px-4 py-2 text-gray-400 rounded-lg hover:bg-gray-800 hover:text-gray-200" to="/teacher/profile">
                                <span class="iconify w-5 h-5" data-icon="mdi:cards-heart"></span>
                                <span class="mx-4 font-medium">Profile</span>
                            </NuxtLink>
                            <NuxtLink class="flex items-center px-4 py-2 mt-5 transition-colors duration-300 transform rounded-lg text-gray-400 hover:bg-gray-800 hover:text-gray-200" to="/teacher/create">
								<span class="iconify w-6 h-6" data-icon="radix-icons:stack"></span>
                                <span class="mx-4 font-medium">Create</span>
                            </NuxtLink>
                            <NuxtLink class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" to="/teacher/courses">
